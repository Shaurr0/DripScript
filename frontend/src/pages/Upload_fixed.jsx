    ...
    try {
      ...
      if (response.ok) {
        ...
        if (result.success && result.analysis) {
          ...
          const suggestions = {
            name: aiAnalysis.name || 'Stylish Item',
            category: aiAnalysis.category || 'tops',
            color: aiAnalysis.color?.toLowerCase() || 'blue',
      ...
      const fallbackSuggestions = {
        ...
        category: fileName.toLowerCase().includes('shirt') ? 'tops' :
                 ...
                 fileName.toLowerCase().includes('shoe') ? 'shoes' : 'tops',
        color: fileName.toLowerCase().includes('black') ? 'black' :
               fileName.toLowerCase().includes('blue') ? 'blue' :
               fileName.toLowerCase().includes('white') ? 'white' :
               fileName.toLowerCase().includes('red') ? 'red' :
               fileName.toLowerCase().includes('yellow') ? 'yellow' : 'blue',
        vibe: 'casual',
